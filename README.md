...
ansible-playbook playbooks/cloud-server/vpn/add-clients.yml --become --become-password-file=.become_pwds/cloud_server_spear --vault-password-file .vault_pwd -e '{"client_names": ["alexander_malyuk"]}'
